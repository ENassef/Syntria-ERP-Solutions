    ...
    <>
      ...
      <div className="mt-[50px] relative w-full max-w-[945px] h-[250px] sm:h-[294px] mx-auto rounded-md overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
          <p className="font-bold text-[18px] cursor-text-hover sm:text-[22px] md:text-[28px] lg:text-[32px] leading-[28px] sm:leading-[40px] text-white max-w-[90%] sm:max-w-[800px] mb-4 font-primary">
      ...
      <section className="mt-12 sm:mt-20 bg-[#0E1F51] text-white px-6 sm:px-12 lg:px-20 py-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* first */}
          <div>
            <h2 className="cursor-text-hover font-bold font-primary mb-5 relative inline-block after:content-[''] after:block after:w-9 after:h-[4px] after:bg-red-500 after:mt-2">
              About Us
            </h2>
            <p className="text-[15px] sm:text-[16px] leading-[22px] cursor-text-hover">
              It is a long established fact that a reader will be distracted by the readable content of a page when looking at
            </p>
            <div className="flex space-x-3 mt-6 font-primary cursor-hover">
          ...
          {/* second */}
          <div>
            <h2 className="cursor-text-hover font-bold font-primary mb-4 relative inline-block after:content-[''] after:block after:w-9 after:h-[4px] after:bg-red-500 after:mt-2">
              Services
            </h2>
            <ul className="cursor-text-hover space-y-2 font-medium text-[15px] sm:text-[16px] leading-[22px] sm:leading-[24px] font-primary">
          ...
          <div>
            ...
            <div className="space-y-5">
              <div className="flex items-center space-x-3 font-primary">
                <span className="text-[#FF3E54] cursor-hover bg-white w-9 h-9 rounded-md flex justify-center items-center">
                  <i className="fa-brands fa-react text-[22px]"></i>
                </span>
                <div className='cursor-text-hover'>
              ...
              <div className="flex items-center space-x-3 font-primary">
                <span className="cursor-hover text-[#FF3E54] bg-white w-9 h-9 rounded-md flex justify-center items-center">
          ...
          <div>
            ...
            <p className="mb-4 font-primary text-[15px] sm:text-[16px] cursor-text-hover">
              It is a long established fact that a reader will be distracted by the readable
            </p>
            <input
              type="email"
              placeholder="Email"
              className="cursor-text-hover w-full h-[40px] rounded-md outline-0 px-2 bg-white text-black mb-4"
            />
            <div className="flex justify-end">
              <button className="cursor-hover bg-[#FF3E54] rounded-[5px] px-5 sm:px-6 py-2 text-white font-medium font-primary text-[14px] md:text-[16px]">
                Submit
              </button>
            </div>
          </div>
